export default {
    registration: {
        ...
        invalidTelephone: 'Telephone must be between 3 and 32 characters!',
    ...
    login: {
        ...
        invalid: 'Warning: No match for E-Mail Address and/or Password.',
        wrong_3_attempts: 'Warning: Your account has exceeded allowed number of login attempts. Please try again in 1 hour.'
    },
    forgot_password: {
